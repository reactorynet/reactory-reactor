...
const WORKFLOW_TOOL_INCLUDES = [
  ...
  'readSkill',
  'searchSkills',
  // UI & Side Panel Component mounting tools
  'component',
  'form',
  'chart',
  'd3',
...
const WORKFLOW_RESOURCES: IAIPersonaResource[] = [
  ...
  },
  {
    ...
    description: 'The progressive web application for the Reactory client (includes Workflow Designer and UI components).',
    type: 'directory',
    url: path.join(REACTORY_HOME, '/reactory-pwa-client/'),
    created: new Date(),
  },
  {
...
export const WorkflowWillPersona: IAIPersona = {
  ...
  toolProfiles: [
    {
      name: "Workflow Development & Execution Tools",
      description: "A collection of tools for designing, validating, executing, debugging, and scheduling YAML and code-based workflows.",
      tools: [
        "executeYamlWorkflow",
        "saveWorkflowYaml",
        "validateWorkflowYaml",
    ...
    {
      name: "UI Component, Form & Visualization Tools",
      description: "Tools for mounting, rendering, and controlling React components (including the visual Workflow Designer), JSON Schema forms, D3 charts, images, and inspecting side panel state.",
      tools: [
        "component",
        "form",
        "chart",
    ...
    {
      name: "System Graph & Project Catalog Tools",
      description: "Tools for searching and traversing the Reactor system graph, cataloging projects, and managing perspectives.",
      tools: [
        "listProjects",
        "getProject",
        "createProject",
