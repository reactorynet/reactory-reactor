...
/**
 * Return type for CodeReviewFile macro
 */
export interface CodeReviewFileMacroResult {
  /** Whether the operation was successful */
  success: boolean;
  /** Error message if operation failed */
  error?: string;
  /** Code review data if operation succeeded */
  data?: {
    /** File path that was reviewed */
    path: string;
    /** Review content in markdown format */
    review: string;
    /** Target output type used */
    target: string;
    /** Target file path (if applicable) */
    targetPath?: string;
    /** Specification file used (if any) */
    specs?: string;
    /** Whether review was written to file */
...
/**
 * Return type for CodeReview macro
 */
export interface CodeReviewMacroResult {
  /** Whether the operation was successful */
  success: boolean;
  /** Error message if operation failed */
  error?: string;
  /** Code review data if operation succeeded */
  data?: {
    /** Directory path that was reviewed */
    path: string;
    /** Review content in markdown format */
    review: string;
    /** Target output type used */
