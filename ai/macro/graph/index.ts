...
import GetGraphNodeMacroDefinition from "./GetGraphNode.macro";
import GetNodeChildrenMacroDefinition from "./GetNodeChildren.macro";
...
export default [
  ...
  GetGraphNodeMacroDefinition,
  GetNodeChildrenMacroDefinition,
