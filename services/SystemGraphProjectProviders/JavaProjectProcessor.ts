...
class JavaProjectProcessor implements IProjectProcessor, AttributeProvider {
  ...
  static reactory: Reactory.Service.IReactoryServiceDefinition<JavaProjectProcessor> = {
    ...
    service(props: Reactory.Service.IReactoryServiceProps, context: Reactory.Server.IReactoryContext) {
      return new JavaProjectProcessor(props, context);
    },    
    dependencies: [
...
export default JavaProjectProcessor.reactory;