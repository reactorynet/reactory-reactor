...
class ReactNativeProjectProcessor implements IProjectProcessor, AttributeProvider {
  ...
  static reactory: Reactory.Service.IReactoryServiceDefinition<ReactNativeProjectProcessor> = {
    ...
    service(props: Reactory.Service.IReactoryServiceProps, context: Reactory.Server.IReactoryContext) {
      return new ReactNativeProjectProcessor(props, context);
    },    
    dependencies: [
...
export default ReactNativeProjectProcessor.reactory;